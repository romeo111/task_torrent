# Chunk: openonco-shelf-zero-bma-mf-sezary-2026-05-06

> Mycosis Fungoides / Sezary BMA expansion. Piece 09/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
`bma-drafting`, `coverage-gap`, `dermatology`

## Mission

Execute one 10-Drop shelf piece for `DIS-MF-SEZARY`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-zero-bma-mf-sezary-2026-05-06/`; hosted clinical content is not edited directly.
...
- `DIS-MF-SEZARY:DROP-01`
- `DIS-MF-SEZARY:DROP-02`
- `DIS-MF-SEZARY:DROP-03`
- `DIS-MF-SEZARY:DROP-04`
- `DIS-MF-SEZARY:DROP-05`
- `DIS-MF-SEZARY:DROP-06`
- `DIS-MF-SEZARY:DROP-07`
- `DIS-MF-SEZARY:DROP-08`
- `DIS-MF-SEZARY:DROP-09`
- `DIS-MF-SEZARY:DROP-10`

## Output Format

- `contributions/openonco-shelf-zero-bma-mf-sezary-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-zero-bma-mf-sezary-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-zero-bma-mf-sezary-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-zero-bma-mf-sezary-2026-05-06/` are touched.
