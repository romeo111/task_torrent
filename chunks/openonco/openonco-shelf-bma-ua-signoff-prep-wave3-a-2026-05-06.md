# Chunk: openonco-shelf-bma-ua-signoff-prep-wave3-a-2026-05-06

> BMA Ukrainian signoff prep wave 3A. Piece 26/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
Execute one 10-Drop shelf piece for `BMA-UA-SIGNOFF-W3A`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-bma-ua-signoff-prep-wave3-a-2026-05-06/`; hosted clinical content is not edited directly.
...
- `BMA-UA-SIGNOFF-W3A:DROP-01`
- `BMA-UA-SIGNOFF-W3A:DROP-02`
- `BMA-UA-SIGNOFF-W3A:DROP-03`
- `BMA-UA-SIGNOFF-W3A:DROP-04`
- `BMA-UA-SIGNOFF-W3A:DROP-05`
- `BMA-UA-SIGNOFF-W3A:DROP-06`
- `BMA-UA-SIGNOFF-W3A:DROP-07`
- `BMA-UA-SIGNOFF-W3A:DROP-08`
- `BMA-UA-SIGNOFF-W3A:DROP-09`
- `BMA-UA-SIGNOFF-W3A:DROP-10`

## Output Format

- `contributions/openonco-shelf-bma-ua-signoff-prep-wave3-a-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-bma-ua-signoff-prep-wave3-a-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-bma-ua-signoff-prep-wave3-a-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-bma-ua-signoff-prep-wave3-a-2026-05-06/` are touched.
