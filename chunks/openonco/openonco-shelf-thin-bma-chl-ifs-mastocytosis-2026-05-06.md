# Chunk: openonco-shelf-thin-bma-chl-ifs-mastocytosis-2026-05-06

> Thin BMA expansion: CHL, IFS, mastocytosis. Piece 16/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
Execute one 10-Drop shelf piece for `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-thin-bma-chl-ifs-mastocytosis-2026-05-06/`; hosted clinical content is not edited directly.
...
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-01`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-02`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-03`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-04`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-05`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-06`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-07`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-08`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-09`
- `DIS-CHL;DIS-IFS;DIS-MASTOCYTOSIS:DROP-10`

## Output Format

- `contributions/openonco-shelf-thin-bma-chl-ifs-mastocytosis-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-thin-bma-chl-ifs-mastocytosis-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-thin-bma-chl-ifs-mastocytosis-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-thin-bma-chl-ifs-mastocytosis-2026-05-06/` are touched.
