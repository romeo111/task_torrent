# Chunk: openonco-shelf-thin-bma-et-hgbl-mtc-2026-05-06

> Thin BMA expansion: ET, HGBL-DH, MTC. Piece 21/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
Execute one 10-Drop shelf piece for `DIS-ET;DIS-HGBL-DH;DIS-MTC`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-thin-bma-et-hgbl-mtc-2026-05-06/`; hosted clinical content is not edited directly.
...
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-01`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-02`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-03`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-04`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-05`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-06`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-07`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-08`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-09`
- `DIS-ET;DIS-HGBL-DH;DIS-MTC:DROP-10`

## Output Format

- `contributions/openonco-shelf-thin-bma-et-hgbl-mtc-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-thin-bma-et-hgbl-mtc-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-thin-bma-et-hgbl-mtc-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-thin-bma-et-hgbl-mtc-2026-05-06/` are touched.
