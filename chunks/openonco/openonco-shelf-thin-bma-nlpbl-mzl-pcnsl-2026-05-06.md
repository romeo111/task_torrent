# Chunk: openonco-shelf-thin-bma-nlpbl-mzl-pcnsl-2026-05-06

> Thin BMA expansion: NLPBL, MZL, PCNSL. Piece 17/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
Execute one 10-Drop shelf piece for `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-thin-bma-nlpbl-mzl-pcnsl-2026-05-06/`; hosted clinical content is not edited directly.
...
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-01`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-02`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-03`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-04`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-05`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-06`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-07`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-08`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-09`
- `DIS-NLPBL;DIS-NODAL-MZL;DIS-PCNSL:DROP-10`

## Output Format

- `contributions/openonco-shelf-thin-bma-nlpbl-mzl-pcnsl-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-thin-bma-nlpbl-mzl-pcnsl-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-thin-bma-nlpbl-mzl-pcnsl-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-thin-bma-nlpbl-mzl-pcnsl-2026-05-06/` are touched.
