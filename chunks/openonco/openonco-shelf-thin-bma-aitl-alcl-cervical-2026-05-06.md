# Chunk: openonco-shelf-thin-bma-aitl-alcl-cervical-2026-05-06

> Thin BMA expansion: AITL, ALCL, cervical. Piece 20/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
Execute one 10-Drop shelf piece for `DIS-AITL;DIS-ALCL;DIS-CERVICAL`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-thin-bma-aitl-alcl-cervical-2026-05-06/`; hosted clinical content is not edited directly.
...
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-01`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-02`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-03`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-04`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-05`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-06`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-07`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-08`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-09`
- `DIS-AITL;DIS-ALCL;DIS-CERVICAL:DROP-10`

## Output Format

- `contributions/openonco-shelf-thin-bma-aitl-alcl-cervical-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-thin-bma-aitl-alcl-cervical-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-thin-bma-aitl-alcl-cervical-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-thin-bma-aitl-alcl-cervical-2026-05-06/` are touched.
