# Chunk: openonco-shelf-thin-bma-ptld-pv-sclc-2026-05-06

> Thin BMA expansion: PTLD, PV, SCLC. Piece 18/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
Execute one 10-Drop shelf piece for `DIS-PTLD;DIS-PV;DIS-SCLC`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-thin-bma-ptld-pv-sclc-2026-05-06/`; hosted clinical content is not edited directly.
...
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-01`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-02`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-03`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-04`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-05`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-06`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-07`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-08`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-09`
- `DIS-PTLD;DIS-PV;DIS-SCLC:DROP-10`

## Output Format

- `contributions/openonco-shelf-thin-bma-ptld-pv-sclc-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-thin-bma-ptld-pv-sclc-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-thin-bma-ptld-pv-sclc-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-thin-bma-ptld-pv-sclc-2026-05-06/` are touched.
