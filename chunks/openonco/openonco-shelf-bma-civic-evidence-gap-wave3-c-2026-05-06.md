# Chunk: openonco-shelf-bma-civic-evidence-gap-wave3-c-2026-05-06

> CIViC evidence_sources gap wave 3C. Piece 25/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
Execute one 10-Drop shelf piece for `BMA-CIVIC-GAP-W3C`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-bma-civic-evidence-gap-wave3-c-2026-05-06/`; hosted clinical content is not edited directly.
...
- `BMA-CIVIC-GAP-W3C:DROP-01`
- `BMA-CIVIC-GAP-W3C:DROP-02`
- `BMA-CIVIC-GAP-W3C:DROP-03`
- `BMA-CIVIC-GAP-W3C:DROP-04`
- `BMA-CIVIC-GAP-W3C:DROP-05`
- `BMA-CIVIC-GAP-W3C:DROP-06`
- `BMA-CIVIC-GAP-W3C:DROP-07`
- `BMA-CIVIC-GAP-W3C:DROP-08`
- `BMA-CIVIC-GAP-W3C:DROP-09`
- `BMA-CIVIC-GAP-W3C:DROP-10`

## Output Format

- `contributions/openonco-shelf-bma-civic-evidence-gap-wave3-c-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-bma-civic-evidence-gap-wave3-c-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-bma-civic-evidence-gap-wave3-c-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-bma-civic-evidence-gap-wave3-c-2026-05-06/` are touched.
