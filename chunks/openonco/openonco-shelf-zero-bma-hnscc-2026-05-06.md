# Chunk: openonco-shelf-zero-bma-hnscc-2026-05-06

> Head and neck SCC BMA expansion. Piece 06/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
`bma-drafting`, `coverage-gap`, `head-and-neck`

## Mission

Execute one 10-Drop shelf piece for `DIS-HNSCC`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-zero-bma-hnscc-2026-05-06/`; hosted clinical content is not edited directly.
...
verification_cost:
  maintainer_hours: 2
  expert_hours: 2
  expert_specialty: head-and-neck
...
- `contributions/openonco-shelf-zero-bma-hnscc-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-zero-bma-hnscc-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-zero-bma-hnscc-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-zero-bma-hnscc-2026-05-06/` are touched.
