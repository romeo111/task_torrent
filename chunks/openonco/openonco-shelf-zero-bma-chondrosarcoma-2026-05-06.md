# Chunk: openonco-shelf-zero-bma-chondrosarcoma-2026-05-06

> Chondrosarcoma BMA expansion. Piece 03/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
`bma-drafting`, `coverage-gap`, `sarcoma`

## Mission

Execute one 10-Drop shelf piece for `DIS-CHONDROSARCOMA`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-zero-bma-chondrosarcoma-2026-05-06/`; hosted clinical content is not edited directly.
...
- `DIS-CHONDROSARCOMA:DROP-01`
- `DIS-CHONDROSARCOMA:DROP-02`
- `DIS-CHONDROSARCOMA:DROP-03`
- `DIS-CHONDROSARCOMA:DROP-04`
- `DIS-CHONDROSARCOMA:DROP-05`
- `DIS-CHONDROSARCOMA:DROP-06`
- `DIS-CHONDROSARCOMA:DROP-07`
- `DIS-CHONDROSARCOMA:DROP-08`
- `DIS-CHONDROSARCOMA:DROP-09`
- `DIS-CHONDROSARCOMA:DROP-10`

## Output Format

- `contributions/openonco-shelf-zero-bma-chondrosarcoma-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-zero-bma-chondrosarcoma-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-zero-bma-chondrosarcoma-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-zero-bma-chondrosarcoma-2026-05-06/` are touched.
