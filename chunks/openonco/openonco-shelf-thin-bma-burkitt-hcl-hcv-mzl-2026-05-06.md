# Chunk: openonco-shelf-thin-bma-burkitt-hcl-hcv-mzl-2026-05-06

> Thin BMA expansion: Burkitt, HCL, HCV-MZL. Piece 15/30 of the 2026-05-06 OpenOnco TaskTorrent shelf expansion.
...
`bma-drafting`, `coverage-gap`, `hematology`

## Mission

Execute one 10-Drop shelf piece for `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL`. The contributor produces reviewable sidecars or reports only under `contributions/openonco-shelf-thin-bma-burkitt-hcl-hcv-mzl-2026-05-06/`; hosted clinical content is not edited directly.
...
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-01`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-02`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-03`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-04`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-05`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-06`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-07`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-08`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-09`
- `DIS-BURKITT;DIS-HCL;DIS-HCV-MZL:DROP-10`

## Output Format

- `contributions/openonco-shelf-thin-bma-burkitt-hcl-hcv-mzl-2026-05-06/task_manifest.txt`
- `contributions/openonco-shelf-thin-bma-burkitt-hcl-hcv-mzl-2026-05-06/_contribution_meta.yaml`
- `contributions/openonco-shelf-thin-bma-burkitt-hcl-hcv-mzl-2026-05-06/drop_*.yaml` or topic-specific sidecars described in the opened issue body.
...
- [ ] No files outside `contributions/openonco-shelf-thin-bma-burkitt-hcl-hcv-mzl-2026-05-06/` are touched.
